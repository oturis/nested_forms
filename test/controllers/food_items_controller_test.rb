...
class FoodItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create food_item" do
    assert_difference('FoodItem.count') do
      post food_items_url, params: { food_item: { food_item: @food_item.food_item, price: @food_item.price, shopping_list_id: @food_item.shopping_list_id } }
    end
  ...
  test "should update food_item" do
    patch food_item_url(@food_item), params: { food_item: { food_item: @food_item.food_item, price: @food_item.price, shopping_list_id: @food_item.shopping_list_id } }
